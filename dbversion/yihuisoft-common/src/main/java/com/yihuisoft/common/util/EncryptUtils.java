...
public class EncryptUtils {
    ...
    public static byte[] getKeyBytes(String strKey) throws Exception {
        ...
        alg.update(strKey.getBytes("UTF-8"));
...
//
//        }
        System.arraycopy(bkey,0,bkey24,0,bkey.length);
    ...
    public static String byte2hex(byte[] b) {
        ...
        StringBuffer hsBuf = new StringBuffer();
        ...
        return hsBuf.toString().toUpperCase();
